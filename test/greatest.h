...
#define GREATEST_ASSERT_NOT_NULL(COND)                                  \
    GREATEST_ASSERTm(#COND " is NULL", COND != NULL)
#define GREATEST_ASSERT_NOT_NULLm(MSG, COND)                            \
    GREATEST_ASSERTm(MSG, COND != NULL)
...
#define ASSERT_NOT_NULL GREATEST_ASSERT_NOT_NULL
#define ASSERT_NOT_NULLm GREATEST_ASSERT_NOT_NULLm
